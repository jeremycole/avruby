...
module AVR
  class Opcode
    ...
    sig do
      returns(T.proc.params(cpu: CPU, memory: T.nilable(Memory), args: T::Array[T.untyped]).void)
    end
    ...
    sig do
      params(
        ...
        opcode_proc: T.proc.params(cpu: CPU, memory: T.nilable(Memory), args: T::Array[T.untyped]).void
      ).void
    end
    ...
    def validate_arg(arg, arg_number)
      ...
      when :absolute_pc
        ...
        return ConstantOutOfRange unless arg >= 0 && arg <= (2**22).to_i - 1
    ...
    sig { params(pattern: String, mnemonic: Symbol, block: T.untyped).void }
